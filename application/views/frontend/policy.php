	            ...
	            <div class="col-sm-24">
	                <div class="breadcrumbs">
	                    <ul>
	                        ...
	                        <li class="product"> 
	                        <strong>Chính sách bảo mật</strong></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
                	...
                	<div class="row">
                		<div class="em-col-main col-sm-24">
                            ...
                            <div class="category-product">
                            	<div id="" class="cmspage" style="text-align: justify">
                            		<p>Cám ơn quý khách đã truy cập vào website eShop được vận hành bởi Công ty Cổ Phần Siêu Mua. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của bạn. Xin vui lòng đọc bản Chính sách bảo mật dưới đây để hiểu hơn những cam kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của người truy cập.</p>
									...
									<p>Quý khách có quyền yêu cầu truy cập vào dữ liệu cá nhân của mình, có quyền yêu cầu chúng tôi sửa lại những sai sót trong dữ liệu của bạn mà không mất phí. Bất cứ lúc nào bạn cũng có quyền yêu cầu chúng tôi ngưng sử dụng dữ liệu cá nhân của bạn cho mục đích tiếp thị.</p></div>
                            </div>
                        </div>
                	</div>
                </div>
