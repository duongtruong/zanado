                        ...
                        <fieldset>
                            ...
                            <div class="forms-content">
                                ...
                                <div class="controls">
                                  <div style="position:relative;">
                                    <div class="input-append">
                                      <input readonly="" id="icon-field" type="text" value="<?php if(isset($predata)) echo $predata['icon']?>" class="span4" name="icon">
                              ...
                              <div class="control-group">											
                                ...
                                <div class="controls">
                                    <input name="fullname" type="text" class="span4 form-control" required="required" placeholder="" value="<?php if(isset($predata)) echo $predata['fullname']?>" />
                                </div> <!-- /controls -->				
                              </div> <!-- /control-group -->
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input type="email" name="email" id="inputSource" class="form-control span4" required="required" value="<?php if(isset($predata)) echo $predata['email']?>" title="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input data-minlength="6" type="text" name="username" id="inputSource" class="form-control span4" required="required" value="<?php if(isset($predata)) echo $predata['username']?>" title="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input type="password" name="password" id="inputSource" class="form-control span4" required="required" value="" title="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input type="password" name="repassword" id="inputSource" class="form-control span4" required="required" value="" title="">
                                      </div>
                                  </div>
                              </div>
