                        ...
                        <fieldset>
                            ...
                            <div class="forms-content">
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input readonly="" type="email" name="email" id="inputSource" class="form-control span4" required="required" value="<?php if(isset($details)) echo $details['email']?>" title="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <div class="input-group span9 mgr-left-0">
                                          <input readonly="" type="text" name="username" id="inputSource" class="form-control span4" required="required" value="<?php if(isset($details)) echo $details['username']?>" title="">
                                      </div>
                                  </div>
                              </div>
