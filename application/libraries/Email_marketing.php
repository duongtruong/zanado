...
class Email_marketing extends MY_Email{
    ...
    function sendEmailLazada($username, $email, $link, $fullname){
        ...
        $subject = "Thông Tin Điện Thoại Apple Iphone 6 Từ Lazada!!!";
        $this->ci = & get_instance();
        $template = ROOT_PATH.'/application/modules/background/views/lazada/lazada';       
        $temp = $this->render($template, $data);
        $from_sender = "tatashop.net@gmail.com";
        $name_sender = "Giới Thiệu Sản Phẩm - TaTa";
        $from_reply_to = "tatashop.net@gmail.com";
        $mail = array(
            "to_receiver"   => $email,
            "message"       => $temp,
