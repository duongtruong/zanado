(function($) {
    ...
    function setColumnCountGridMode_em_fashion_new_arrivals_tab01() {
        ...
        if (EM.SETTING.DISABLE_RESPONSIVE == 1) {
            ...
            if (wWin > 1200) {
                if (!sGrid.hasClass(sDesktop + '5')) {
                    sGrid.removeClass().addClass(sDesktop + '5');
                }
            } else {
                if (wWin <= 1200 && wWin > 768) {
                    if (!sGrid.hasClass(sDesktopSmall + '5')) {
                        sGrid.removeClass().addClass(sDesktopSmall + '5');
                    }
                } else {
                    if (wWin <= 768 && wWin > 480) {
                        if (!sGrid.hasClass(sTablet + '5')) {
                            sGrid.removeClass().addClass(sTablet + '5');
                        }
                    } else {
                        if (!sGrid.hasClass(sMobile + '5')) {
                            sGrid.removeClass().addClass(sMobile + '5');
                        }
                    }
                }
            }
    ...
    jQuery(document).ready(function() {
        ...
        setEqualElement('.em-wrapper-new-arrivals-tabs', '.product-name');
...
var isWindowPhone = '';
var language = 'public/images/language/';
var urlsite = '';
